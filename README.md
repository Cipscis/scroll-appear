...
![Build and deploy status badge](https://github.com/cipscis/scroll-appear/actions/workflows/build-and-deploy.yml/badge.svg)
...
See [Scroll Appear documentation](https://cipscis.github.io/scroll-appear/)
...
* `npm run prepare` first removes directories containing compiled files, then lints and compiles any TypeScript. You should never need to run this task manually, [the `prepare` script runs automatically](https://docs.npmjs.com/cli/v7/using-npm/scripts#life-cycle-scripts) when npm prepares your package for publishing.
